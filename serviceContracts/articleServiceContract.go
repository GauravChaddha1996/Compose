...
type ArticleServiceContract interface {
	...
	ChangeArticleTopCommentCount(articleId string, change bool, transaction *gorm.DB) error // send change true to increase and false to decrease
	...
	GetArticleTopCommentCount(articleId string) uint64
	ChangeArticleReplyCommentCount(articleId string, change bool, transaction *gorm.DB) error // send change true to increase and false to decrease
}
